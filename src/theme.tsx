const baseColorPalette = {
    ...
    colorBasePineGreen: '#008073',
    //colorBasePineGreen: '#3f51b5',
...
const guidelineColors = {
    ...
    green: baseColorPalette.colorBasePineGreen,
    accent: {
        primary: baseColorPalette.colorBasePineGreen,
        secondary: baseColorPalette.colorBaseYellow,
        tertiary: baseColorPalette.colorBaseDarkBlue,
    },
    states: {
        error: baseColorPalette.colorBasePineGreen,
